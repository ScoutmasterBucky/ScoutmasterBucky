...
import('glob-to-regexp').then(globToRegExp => {
    import('fudgel').then(({ component, css, html, rootElement }) => {
        ...
        component(
            'offer-suggestions',
            {
                ...
                template: html`
                    ...
                    <p>
                        The file you were attempting to reach no longer is at
                        this location. From time to time, we move files around
                        to improve our site structure, for updated content, or
                        to remove outdated information.
                    </p>

                    <div *if="suggestions?.length">
                        <p>
                            Here are some suggestions that might help you find
                    ...
                    <p>
                        ...
                        find what you are looking for, or return to the
                        <a href="/">home page</a>.
                    </p>
                `,
            },
